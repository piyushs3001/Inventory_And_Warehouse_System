...
export default function ForgotPasswordPage() {
  ...
  const onSubmit = async (e: FormEvent): Promise<void> => {
    ...
    try {
      ...
      await authControllerForgotPassword({ email, app: 'admin' });
      setSent(true);
    } catch {
    ...
    <main className="grid min-h-screen lg:grid-cols-[1.1fr_1fr]">
      ...
      <div className="grid place-items-center overflow-y-auto p-8">
        <div className="w-full max-w-[382px]">
          ...
          {sent ? (
            <>
              <h1 className="text-[1.6rem] font-bold tracking-[-0.025em]">Check your inbox</h1>
            ...
            <form onSubmit={onSubmit} noValidate>
              <h1 className="text-[1.6rem] font-bold tracking-[-0.025em]">Forgot your password?</h1>
