    ...
    <main className="grid min-h-screen lg:grid-cols-[1.1fr_1fr]">
      ...
      <div className="grid place-items-center overflow-y-auto p-8">
        <div className="w-full max-w-[382px]">
          {done ? (
            <>
              <h1 className="text-[1.55rem] font-bold tracking-[-0.025em]">Password updated</h1>
            ...
            <>
              <h1 className="text-[1.55rem] font-bold tracking-[-0.025em]">Link expired</h1>
            ...
            <form onSubmit={onSubmit} noValidate>
              <h1 className="text-[1.55rem] font-bold tracking-[-0.025em]">Set a new password</h1>
